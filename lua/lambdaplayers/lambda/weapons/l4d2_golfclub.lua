...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    ...
    meathook = {
        ...
        callback = function( self, wepent, target )
            ...
            wepent:EmitSound('lambdaplayers/weapon/left4dead2/golf_club/wpn_golf_club_swing_miss_0'..math.random(2)..'.wav', 65)
            ...
            self:SimpleTimer( 0.3, function()
                ...
                target:EmitSound('lambdaplayers/weapon/left4dead2/golf_club/wpn_golf_club_melee_0'..math.random(2)..'.wav', 80)
                target:EmitSound('lambdaplayers/weapon/left4dead2/golf_club/wpn_golf_club_swing_miss'..math.random(2)..'.wav', 65)
