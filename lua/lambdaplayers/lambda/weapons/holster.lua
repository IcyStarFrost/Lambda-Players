...
--[[ 
    ...
    SHARED     | OnDrop( Entity lambda, Entity wepent, Entity dropEnt )                                                         | Function |    A function that will be called when weapon's dropped prop or entity is created. Will be serverside if its a dropped entity and clientside if it's a prop | OPTIONAL
