...
--[[ 
    ...
    SERVERSIDE | OnDealDamage( Entity lambda, Entity wepent, Entity target, DMGINFO dmginfo )  | Function |    A function that will be called when the Lambda Player successfully deals damage to something with this weapon | OPTIONAL
