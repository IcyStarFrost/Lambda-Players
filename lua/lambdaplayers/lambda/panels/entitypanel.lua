...
RegisterLambdaPanel( "Entity", "Opens a panel that allows you to choose what Entities Lambdas are allowed to spawn. You must a Super Admin to use this Panel.", OpenEntityPanel )