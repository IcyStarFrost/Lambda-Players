...
CreateLambdaConvar( "lambdaplayers_displayinfo", 1, true, true, false, "If Lambda Player's name and health should be displayed when we're looking at it and it's above zero", 0, 1, { type = "Bool", name = "Display Name/Health", category = "Lambda Player Settings" } )
