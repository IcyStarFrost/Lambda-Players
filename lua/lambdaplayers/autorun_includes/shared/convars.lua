...
CreateLambdaConvar( "lambdaplayers_lambda_overridegamemodehooks", 0, true, false, false, "If the addon is allowed to override the following GAMEMODE hooks to support Lambda Players: GM:PlayerDeath() GM:OnNPCKilled() Default SandBox Scoreboard : Changing this requires you to restart the server/game for the changes to apply! This can cause conflicts hence why this is off by default", 0, 1, { type = "Bool", name = "Override Gamemode Hooks", category = "Lambda Server Settings" } )
