...
CreateLambdaConvar( "lambdaplayers_lambda_jumpheight", 50, true, false, false, "The jump height the next spawned Lambda Player will have", 0, 500, { type = "Slider", decimals = 0, name = "Jump Height", category = "Lambda Server Settings" } )
