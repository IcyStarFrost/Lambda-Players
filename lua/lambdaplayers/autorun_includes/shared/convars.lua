...
CreateLambdaConvar( "lambdaplayers_lambda_serversideragdollcleanuptime", 15, true, false, false, "The time before Server-side Lambda ragdolls are removed. NOTE: 5 SECONDS WILL BE ADDED ONTO THE COUNT TO COMPENSATE FOR CLEANUP EFFECTS", 0, 190, { type = "Slider", decimals = 0, name = "Ragdoll Cleanup Time", category = "Utilities" } )
