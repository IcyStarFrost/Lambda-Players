...
CreateLambdaConvar( "lambdaplayers_combat_allownadeusage", 0, true, false, false, "If Lambda Players are allowed to use and throw quick nades at their enemy.", 0, 1, { type = "Bool", name = "Allow Quick Nade Usage", category = "Combat" } )
