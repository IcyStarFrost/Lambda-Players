...
CreateLambdaConvar( "lambdaplayers_lambda_drowntime", 15, true, false, false, "The time Lambda Players can be fully submerged in water before they start drowning. Set to zero to disable drowning", 0, 1, { type = "Slider", decimals = 1, name = "Drown Time", category = "Lambda Server Settings" } )
...
CreateLambdaConvar( "lambdaplayers_lambda_walkspeed", 200, true, false, false, "The walking speed the next spawned Lambda Player will have", 100, 1500, { type = "Slider", decimals = 0, name = "Walk Speed", category = "Lambda Server Settings" } )
CreateLambdaConvar( "lambdaplayers_lambda_runspeed", 400, true, false, false, "The running speed the next spawned Lambda Player will have", 100, 1500, { type = "Slider", decimals = 0, name = "Run Speed", category = "Lambda Server Settings" } )
