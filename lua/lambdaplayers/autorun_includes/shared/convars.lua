...
CreateLambdaConvar( "lambdaplayers_voice_usegmodvoicepopups", 0, true, true, false, "If Lambda Players should use Garry's Mod's Voice Pop up system instead of their own system. This requires Gamemode override setting to be turned on! Go to Lambda Server Settings and the Override Gamemode Hooks option and read the info on that. Note changing this will not take effect instantly. When all Lambdas speaking at the time you change this stops speaking, the change will take place", 0, 1, { type = "Bool", name = "Use Gmod Voice Popups", category = "Voice Options" } )
