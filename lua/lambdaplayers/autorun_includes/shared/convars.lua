...
CreateLambdaConvar( "lambdaplayers_text_chatlimit", 0, true, false, false, "The amount of Lambda Players that can type a message at a time", 0, 1, { type = "Slider", decimals = 0, name = "Chat Limit", category = "Text Chat Options" } )
