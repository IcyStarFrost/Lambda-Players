...
CreateLambdaConvar( "lambdaplayers_lambda_random_healtharmorspawn", 0, true, false, false, "If Lambda Players should have random health/armor upon spawning.", 0, 1, { type = "Bool", decimals = 0, name = "Random Health/Armor On Spawn", category = "Lambda Server Settings" } )
